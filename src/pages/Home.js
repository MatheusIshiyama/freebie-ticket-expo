                ...
                <ScrollView>
                    <View style={recommended.index}>
                        <View style={recommended.header}>
                            <Text style={recommended.title}>For you</Text>
                    ...
                    <View style={collections.index}>
                        <View style={collections.header}>
                            <Text style={collections.title}>Collections</Text>
                        </View>
                        <Carousel
                            layout={"default"}
                    ...
                    <View style={discover.index}>
                        <View style={discover.header}>
                            <Text style={discover.title}>Discover</Text>
                        </View>
                        <ScrollView
                            horizontal
                    ...
                    <View style={coming.index}>
                        <View style={coming.header}>
                            <View style={coming.location}>
                                ...
                                />
                                <Text style={coming.locationText}>WARSHAW</Text>
                            </View>
                            <View style={coming.title}>
                                <Text style={coming.titleText}>Upcoming</Text>
                        ...
                        <View style={coming.eventMonth}>
                            <Text style={coming.eventMonthText}>Sep</Text>
                            {coming_events}
                        </View>
                    </View>
                </ScrollView>
